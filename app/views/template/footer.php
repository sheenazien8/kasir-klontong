...
<!-- AdminLTE App -->
<script src="<?= $GLOBALS['path'];?>public/js/adminlte.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?= $GLOBALS['path'];?>public/js/demo.js"></script>
<script src="<?= $GLOBALS['path'];?>public/js/Slides-SlidesJS-3/source/jquery.slides.min.js"></script>
<script>
  $(function() {
    $('#slides').slidesjs({
      height: 350,
