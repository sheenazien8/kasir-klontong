                ...
                <div class="col-md-12">
                	<div class="box">
			            <div class="box-header">
			              <h3 class="box-title">Daftar Riwayat Transaksi</h3>
			            </div>
			            <!-- /.box-header -->
			            <div class="box-body">
				            <div class="list-group">
				            	...
				            	<?php else: ?>
				              	<?php foreach ($data['tanggal'] as $value): ?>
				           			<a href="<?= $GLOBALS['path'] ?>riwayattransaksi/detail/<?= $value['tanggal'] ?>/" class="list-group-item"><h4>Transaksi <?= $value['tanggal'] ?></h4></a>
				              	<?php endforeach ?>
				            	<?php endif ?>
				            </div>
			            </div>
